...
More than 20 visualizations were created to understand patterns in the data.
...
Result:
Response time has a statistically significant impact on CSAT scores.
...
Result:
Support channel and CSAT score show a significant relationship.
...
Result:
Agent experience level significantly influences customer satisfaction.
...
Incorporating textual analysis of customer feedback

Deploying the model using Streamlit or FastAPI

Building a real-time CSAT prediction system
